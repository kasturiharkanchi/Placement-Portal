      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.html" >Home CVR</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="usn">ID NUM</label>
                  <input type="text" name="USN" class="form-control" id="usn" placeholder="18B81xxxx" >
                </div>
          ...
          <footer class="text-right">
              ...
              <a href="http:cvr.ac.in" target="_parent">Team Predator - CSE DEPARTMENT</a>
			  </p>
          </footer>
        </div>
      </div>
