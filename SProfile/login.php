          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.php">Home CVR</a>
                </li>
                <li>
                  <a href="../../Drives/index.php">Drives Homepage</a>
                </li>
                <li>
                  <a href="../../Homepage/display.php">Notifications</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to CVR</h2>
              <hr>
              ...
              <p>We have got number of Partners from the companies who are tied up to our college and it is Incresasing. We are doing our Job of getting you placed and 
                being a Student , its your duty to accompolish your responsibilities.</p>
            </div>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of CVR Family</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>4.</td>
                        <td>Dr. D. Durga Bhavani</td>
                        
                        <td>@DB</td>
                      </tr>
                      <tr>
                        <td>5.</td>
                        <td>Mrs. S.Suguna Mallika</td>
