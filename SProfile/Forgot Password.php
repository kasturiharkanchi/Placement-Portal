	...
	<body class="light-gray-bg">
		...
		<div class="footer">
			<div class="container">
				...
				<h3>GET IN TOUCH</h3>
					<p>Ibrahimpatnam</p>
					<p>Vasthunagar,Hyderabad, India</p>
					<p>08138-223818/223365</p>
					<a href="mailto:cittumkur@rediffmail.com">placementscvr@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; CVR COLLEGE OF ENGINEERING | Developed by
              <a href="https://cvr.ac.in" target="_parent">Team Predator - CSE department</a>
				</div>
				</div>
