        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://cvr.ac.in/home4/">CVR COLLEGE OF ENGINEERING</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="display.php">Notifications</a>
                        </li>
                    </ul>
			...
			<div class="container">
				...
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						...
						<li>
							<a href =" mailto:placements@cvr.ac.in">Placement Support</a>
						</li>
						<li>
							<a href="mailto:raghava@cvr.ac.in">Faculty Support</a>
						</li>
						<li>
							<a href="http://127.0.0.1/Mini%20Project/Drives/products.php">Registered Companies and Training</a>
						</li>
					</ul>
				</div>
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>Ibrahimpatnam , Hydearbad , India</p>
					<p>040-4200-0000</p>
					<a href="mailto:placements@cvr.ac.in">placementscvr@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p> &copy; CVR COLLEGE OF ENGINEERING</p>
