	...
	<body class="light-gray-bg">
	        		...
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>	        		
		              	<select type="text" name="Question" class="form-control" placeholder="Security Question" > 
								<option value="What is your nickname?">What is your branch?</option>
		...
		<div class="footer">
			<div class="container">
				...
				<h3>GET IN TOUCH</h3>
					<P>Ibrahimpatnam , Hyderabad , India</P>
					<p>08138-223818/223365</p>
					<a href="mailto:placements@cvr.ac.in">placements@cvra.ac.in</a>
				</div>
