      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../../Homepage/index.php">CVR HOME</a></li>
        ...
        <div class="templatemo-content-container">
            ...
            <form action="updatedrive1.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="usn" class="form-control" id="inputusn" placeholder="18B81A***">
                </div>
                
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="Name">Student Name</label>
                  <input type="text"  name="sname" class="form-control" id="inputName" placeholder="Name of the student">
                </div>
          ...
          <footer class="text-right">
             <p>Copyright &copy; @CVR COLLEGE OF ENGINEERING</p>
            </p>
          </footer>
        </div>
      </div>
