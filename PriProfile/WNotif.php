          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../../Homepage/indes.php">Home CVR</a></li>
                <li><a href="">Drives Home</a></li>
                 <li><a href="WNotif.php">Notification</a></li>
            ...
            <form action="WN.php" method="POST">
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    ...
                    <textarea class="form-control" id="inputNote"name="Subject" rows="2"></textarea>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">Message:</label>
                    <textarea class="form-control" id="inputNote"name="Message" rows="5"></textarea>
                </div>
              </div>
